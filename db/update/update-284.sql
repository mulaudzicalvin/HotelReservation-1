...
ALTER TABLE `$prefix_hotels_api` ADD `active` ENUM( '1', '0' ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '1' AFTER `api_ts_code` ;

ALTER TABLE `$prefix_hotels_api` ADD `api_title` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL AFTER `api_name` ;

ALTER TABLE `$prefix_hotels_api` ADD UNIQUE ( `api_name`) ;
