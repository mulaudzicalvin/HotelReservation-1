...
-- 
-- 	Table structure for table `$prefix_hotels_page`
--

ALTER TABLE `$prefix_hotels_page` ADD `checkin_time` ENUM( 'AM', 'PM' ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'AM' AFTER `checkin_date`;

ALTER TABLE `$prefix_hotels_page` ADD `checkout_time` ENUM( 'AM', 'PM' ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'AM' AFTER `checkout_date` ; 