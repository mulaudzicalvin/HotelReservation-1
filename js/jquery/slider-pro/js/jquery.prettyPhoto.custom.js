...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		...
		$.prettyPhoto.changeSettings = function(custom_settings) {
			pp_settings = jQuery.extend({}, pp_settings, custom_settings);
		}
		...
		$.prettyPhoto.open = function(event) {
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(pp_images[set_position])){
					...
					case 'quicktime':
						pp_dimensions = _fitToViewport(movie_width,movie_height); // Fit item to viewport
						pp_dimensions['height']+=80; pp_dimensions['contentHeight']+=80; pp_dimensions['containerHeight']+=80; // Add space for the control bar
