<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../data/frontImages'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filesystem.extensions'] = "png,gif,jpg,jpeg,ppt,pdf,psd,mp3,xls,xlsx,swf,doc,docx,odt,odc,odp,odg,mpp,ogg,ppt,pdf,Jpeg";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,pdf,doc,docx,zip,tar,rar";
