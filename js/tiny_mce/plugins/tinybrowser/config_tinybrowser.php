...
$tinybrowser['path']['image'] = '/flameheat/images/image/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/flameheat/images/media/'; // Media files location
$tinybrowser['path']['file']  = '/flameheat/images/files/'; // Other files location
